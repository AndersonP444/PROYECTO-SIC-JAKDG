        ...
        if usuario_actual:
            ...
            while True:
                ...
                if opcion == 1:  # Estado de cuenta
                    ...
                    nombre_destino = input("Ingrese la cedula del usuario de destino: ")

                    # Buscar el usuario de destino por nombre completo
                    usuario_destino = buscar_usuario_por_credenciales(nombre_destino, clave_usuario_banco)
